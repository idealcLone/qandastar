      ...
      <main className={styles.main}>
        <div className={styles.hero}>
          <div className={styles.container}>
            ...
            <p>
              "Соңғы күндері көрші елде орын алып жатқан жағдайлар бізге де ауыр
              тиіп жатыр. Мобилизация деген сұмдық нәрсе ғой.. Әсіресе Орынбор,
              Омбы, Астрахан өңірлеріндегі майданға жүздеген қазақ
